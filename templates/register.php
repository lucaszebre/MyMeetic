...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
  ...
  <script src="https://cdn.tailwindcss.com"></script>
    ...
    <body class="flex bg-gray-50 dark:bg-gray-900 min-h-[1200px] flex-col w-full h-screen  justify-center items-center overflow-none-y">
...
<div class="flex flex-col items-center justify-center w-screen h-screen  px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="../assets/meetic.png" alt="logo-meetic">
          Meetic   
      </a>
              ...
              <form id="registration" method="post" action="../src/includes/register.inc.php" class="space-y-4 md:space-y-6" >
                  ...
                  <div>
                      ...
                      <select name="genre" id="genre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <option value="male">Male Apha</option>
                        <option value="female">Female</option>
                        <option value="other">Other -_-</option>
                        <option value="cyborg">Cyborg Strong</option>
                    </select>                        
                        <span class="error text-red-500"></span>
                    </div>
                    <div>
                      <label for="passion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Passion</label>
                      <select name="passion" id="passion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="" selected>Choose a passion</option>
